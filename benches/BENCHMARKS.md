...
| ---------------- | -------- | -------- | ---------------------------------------- |
| comprs Lossless  | 7.6 KB   | 17.2 ms  | Baseline (no quantization)               |
| comprs Lossy     | 5.4 KB   | 11.9 ms  | 256 colors, no dithering (-29%)          |
| imagequant       | 64.2 KB  | 49.5 ms  | libimagequant (dithered, larger)         |
| pngquant         | 61.6 KB  | 58.7 ms  | --quality=65-80 (dithered, larger)       |
